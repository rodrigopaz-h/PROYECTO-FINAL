...
const CreateBlogPost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (post.imgsrc) {
        formData.append("image", post.imgsrc);
      }
      ...
      navigate("/"); // Redirige a la página principal o a la lista de posts después de crear
    } catch (err) {
  ...
  const handleImageUpload = (e) => {
    ...
    if (file) {
      ...
      reader.onload = () => {
        ...
        setPost({ ...post, imgsrc: file }); // Actualizar el post con la nueva imagen
      };
